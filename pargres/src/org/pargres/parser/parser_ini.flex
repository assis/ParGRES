...
{SECOND}     {this.yyparser.line = yyline + 1 ; this.yyparser.column = yycolumn + 1 ;              
              this.yyparser.yylval = new ParserIniVal(yytext()); return ParserIni.TK_SECOND;}
              
{MINUTE}      {this.yyparser.line = yyline + 1 ; this.yyparser.column = yycolumn + 1 ;              
              this.yyparser.yylval = new ParserIniVal(yytext()); return ParserIni.TK_MINUTE;}              
              
{HOUR}       {this.yyparser.line = yyline + 1 ; this.yyparser.column = yycolumn + 1 ;              
              this.yyparser.yylval = new ParserIniVal(yytext()); return ParserIni.TK_HOUR;}

{DAY}        {this.yyparser.line = yyline + 1 ; this.yyparser.column = yycolumn + 1 ;              
              this.yyparser.yylval = new ParserIniVal(yytext()); return ParserIni.TK_DAY;}              

{WEEK}       {this.yyparser.line = yyline + 1 ; this.yyparser.column = yycolumn + 1 ;              
              this.yyparser.yylval = new ParserIniVal(yytext()); return ParserIni.TK_WEEK;}
              
{MONTH}      {this.yyparser.line = yyline + 1 ; this.yyparser.column = yycolumn + 1 ;              
              this.yyparser.yylval = new ParserIniVal(yytext()); return ParserIni.TK_MONTH;}
                            
{YEAR}       {this.yyparser.line = yyline + 1 ; this.yyparser.column = yycolumn + 1 ;              
              this.yyparser.yylval = new ParserIniVal(yytext()); return ParserIni.TK_YEAR;}
              
{DECADE}     {this.yyparser.line = yyline + 1 ; this.yyparser.column = yycolumn + 1 ;              
              this.yyparser.yylval = new ParserIniVal(yytext()); return ParserIni.TK_DECADE;}
              
{CENTURY}    {this.yyparser.line = yyline + 1 ; this.yyparser.column = yycolumn + 1 ;              
              this.yyparser.yylval = new ParserIniVal(yytext()); return ParserIni.TK_CENTURY;}
              
{MILLENNIUM} {this.yyparser.line = yyline + 1 ; this.yyparser.column = yycolumn + 1 ;              
              this.yyparser.yylval = new ParserIniVal(yytext()); return ParserIni.TK_MILLENNIUM;}
...
{DATE_TYPE}   {this.yyparser.line = yyline + 1 ; this.yyparser.column = yycolumn + 1 ;              
              this.yyparser.yylval = new ParserIniVal(yytext()); return ParserIni.TK_DATE_TYPE;}
*/
