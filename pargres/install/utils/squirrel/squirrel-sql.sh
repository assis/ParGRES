#! /bin/sh
[ C:\Arquivos de programas\Java\jre1.5.0_01 ] && JAVA=C:\Arquivos de programas\Java\jre1.5.0_01/bin/java || JAVA=java
...
# Squirrel home.
SQUIRREL_SQL_HOME="C:\eclipse3.1M6\workspace\bmiranda_pargres\demo\squirrel"
