...
set TMP_CP="%SQUIRREL_SQL_HOME%\squirrel-sql.jar";..\..\bin
set HOMEPATH=%SQUIRREL_SQL_HOME%
...
SET TMP_PARMS=-loggingConfigFile="%SQUIRREL_SQL_HOME%\log4j.properties"

@rem Run with a command window.
"%LOCAL_JAVA%" -cp %TMP_CP% net.sourceforge.squirrel_sql.client.Main %TMP_PARMS% -settingsdir=.\
